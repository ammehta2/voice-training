"""
Augmentation for the closing-phrase pipeline.

Same approach as 03_augment.py but:
  - operates on data/closing/{positive_raw,negative_raw}
...
NEG_IN = Path("data/closing/negative_raw")
NEG_OUT = Path("data/closing/negative_aug")
