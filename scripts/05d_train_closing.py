"""
Train the closing-phrase ("Padhamam Havai Mangalam") detector.

Reads features from data/closing/features/, saves model to
models/closing_v1_<timestamp>/.
...
class ClosingDetector(nn.Module):
    """Compact DS-CNN for 2.5s closing-phrase detection.
